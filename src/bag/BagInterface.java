...
public interface BagInterface<T> {
     ...
     * 
     * @return Either the removed entry, if the removal was successfull, or null
     */
    public T remove();
     ...
     * @return True if the removal was successfull, or false if not.
     */
